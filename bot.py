...
def main():
	...
	agent = Agent.load("../Respuestas/models/modelo.tar.gz")
	...
	while True:
		...
		try:
			...
			try:
				...
				print(colored("Ocurrió un error al responder", "red"))
				seconds = time.time()
				local_time = time.ctime(seconds)	
				print(colored(local_time, "red"))
				print(e)
				print()
				print()
			...
			print(colored("Ocurrió un error al pedir las menciones", "red"))
			seconds = time.time()
			local_time = time.ctime(seconds)	
			print(colored(local_time, "red"))
			print(e)
